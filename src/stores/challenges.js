...
const currentExperience = writable(0);
const challengesCompleted = writable(0);
const activeChallenge = writable(0);
const experienceToNextLevel = derived(level, ($level, set) => { set(Math.pow(($level + 1) * 4, 2)) }, 1)

const challenges = readable([
    {
        type: "body",
...
export { level, currentExperience, challengesCompleted, activeChallenge, experienceToNextLevel, challenges };